		...
		<div id="my_page_box">
			...
			<div class="outer_content">
				<div class="inner_content">
					<div class="title_letter">주소록 수정</div>
						<table>
							<tr>
								<th>받는 사람*</th>
								<td>
									<input type="text" name="recipient" value="${dto.recipient}" placeholder="받는 사람">
								</td>
							</tr>
							<tr>
								<th>연락처*</th>
								<td>
									<input type="text" name="tel" value="${dto.tel}" placeholder=" 연락처">
								</td>
							</tr>
							<tr>
								<th><label id="address">우편번호*</label></th>
								<td>
									<input type="text" name="zipcode" id="postcode" value="${dto.zipcode}" placeholder=" 우편번호" size=6>
									<input type="button" class="little_btn" onclick="execDaumPostcode();" value=" 주소찾기">
								</td>
							</tr>
							<tr>
								<th>주소*</th>
							...
							<tr>	
								<th>상세주소*</th>
								<td>
									<input type="text" name="detail" id="detailAddress" value="${dto.detail}" placeholder=" 상세주소" size=30>
								</td>
							</tr>
							<tr>
						...
						<br>
						<div class="outer_content">
							<input type="submit" value="배송지 수정" class="little_btn">
